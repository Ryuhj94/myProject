		...
		<div class="middle">
			...
			<div class="util_area">
				<form action="BoardHitDo" method="post">
					<input type="hidden" value="${board.seq }" name="seq"> <input
						type="hidden" value="${board.board_class }" name="board_class">
					<input type="hidden" value="${member.id }" name="id">
					<c:choose>
						<c:when test="${hitState==true }">
							<button id="hit_button">
								<img src="./resources/imgs/hit-Ikon.png">
							</button>
						</c:when>
						<c:otherwise>
							<button id="hit_button">
								<img src="./resources/imgs/hitNone-Ikon.png">
							</button>
						</c:otherwise>
					</c:choose>
				</form>
 			...
 			<a href="board_modify?board_class=${board.board_class}&seq=${board.seq}"><button class="board_button">수정하기</button></a>
 			<a href="boardDelete?board_class=${board.board_class}&seq=${board.seq}"><button class="board_button">게시물 삭제</button></a>
			 </c:if>
		</div>
